...
Technical documentation for the PHAEMOS project.

| File | Description |
| --- | --- |
| [architecture.md](architecture.md) | System diagram, data flow, deployment targets, background tasks |
| [api-reference.md](api-reference.md) | All REST endpoints with auth requirements and request/response shapes |
| [schema.md](schema.md) | PostgreSQL table definitions |
