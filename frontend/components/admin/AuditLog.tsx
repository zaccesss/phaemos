      ...
      <div className="rounded-xl border border-gray-700 overflow-hidden">
              ...
              entries.map((e) => (
                <tr key={e.id} className="hover:bg-white/5 transition-colors">
                  ...
                  <td className="px-4 py-3 text-gray-400">
                    <span className="text-gray-300">{e.resource}</span>
                    <span className="ml-1 font-mono text-xs text-gray-600 truncate max-w-[6rem] inline-block align-bottom">
                      {e.resource_id}
                    </span>
                  </td>
                  <td className="px-4 py-3 text-gray-500 text-xs max-w-[14rem] truncate">
                    {e.detail || '—'}
                  </td>
                </tr>
              ))
        ...
        <div className="flex items-center justify-between px-4 py-3 bg-gray-800/50 border-t border-gray-700">
          <button
            ...
            disabled={skip === 0}
            className="rounded px-3 py-1 text-xs text-gray-400 hover:text-gray-200 disabled:opacity-30 disabled:cursor-not-allowed"
          >
            Previous
          </button>
