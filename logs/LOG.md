...
| [2026-06-15](logs/2026-06-15.md) | Added GitHub Sponsors to FUNDING.yml (PR #143). Fixed 3 CodeQL high findings: webhook URL sanitization via urlparse netloc, phone number removed from SMS log (PR #144). Pinned transitive postcss to 8.5.10 via npm overrides to resolve GHSA-qx2v-qp2m-jg93 in next, closed issue #141 (PR #145). |
